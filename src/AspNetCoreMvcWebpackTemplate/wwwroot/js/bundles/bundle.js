...
/***/ function(module, exports, __webpack_require__) {
	...
	var port = window.location.port && (window.location.protocol.toLowerCase() == "http:" && window.location.port != 80 || window.location.protocol.toLowerCase() == "https:" && window.location.port != 443) ? ":" + window.location.port : "";
	
	var origin = window.location.protocol + "//" + window.location.hostname + port;
	
	var req = function () {
	    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
	        var tokenData, accessToken, values, userinfo;
